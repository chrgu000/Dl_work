...
namespace DAL
{
    ...
    public class BasicInfoDAO
    {
        ...
        {
            bool flag = false;
            string sql = "insert into Dl_opUserAddress (lngopUserId,strDistributionType,strCarplateNumber,strDriverName,strDriverTel,strIdCard,lngCreater,iAddressType) values (@lngopUserId,@strDistributionType,@strCarplateNumber,@strDriverName,@strDriverTel,@strIdCard,@lngCreater,1)";
            SqlParameter[] paras = new SqlParameter[]{
            new SqlParameter("@lngopUserId",lngopUserId),
        ...
        /// <returns></returns>
        public bool Insert_UserAddressPS(string lngopUserId, string strDistributionType, string strConsigneeName, string strConsigneeTel, string strReceivingAddress, string strDistrict,string ccodeid)
        {
            bool flag = false;
            string sql = "insert into Dl_opUserAddress (lngopUserId,strDistributionType,strConsigneeName,strConsigneeTel,strReceivingAddress,strDistrict,iAddressType,ccodeid) values (@lngopUserId,@strDistributionType,@strConsigneeName,@strConsigneeTel,@strReceivingAddress,@strDistrict,2,@ccodeid)";
            SqlParameter[] paras = new SqlParameter[]{
            new SqlParameter("@lngopUserId",lngopUserId),
            new SqlParameter("@strDistributionType",strDistributionType),
        ...
        #region 新增加(自提托运)[Insert_UserAddressZTPS]
        /// <summary>
        /// 新增加(配送)
        /// </summary>
        /// <param name="lngopUserId">用户id</param>
        ...
        /// <param name="strReceivingAddress">收货地址</param>
        /// <returns></returns>
        public bool Insert_UserAddressZTPS(string lngopUserId, string strDistributionType, string strConsigneeName, string strConsigneeTel, string strReceivingAddress, string strDistrict, string ccodeid)
        {
            bool flag = false;
            string sql = "insert into Dl_opUserAddress (lngopUserId,strDistributionType,strConsigneeName,strConsigneeTel,strReceivingAddress,strDistrict,iAddressType,ccodeid) values (@lngopUserId,@strDistributionType,@strConsigneeName,@strConsigneeTel,@strReceivingAddress,@strDistrict,3,@ccodeid)";
            SqlParameter[] paras = new SqlParameter[]{
            new SqlParameter("@lngopUserId",lngopUserId),
            new SqlParameter("@strDistributionType",strDistributionType),
            new SqlParameter("@strConsigneeName",strConsigneeName),
        ...
        #endregion
        #region 修改(自提托运)[Update_UserAddressZTPS]
        /// <summary>
        /// 修改(配送)
        /// </summary>
        /// <param name="ba"></param>
        /// <returns></returns>
        public bool Update_UserAddressZTPS(BasicInfo ba,string ccodeid)
        {
            bool flag = false;
            string sql = "update Dl_opUserAddress set strConsigneeName=@strConsigneeName,strConsigneeTel=@strConsigneeTel,strReceivingAddress=@strReceivingAddress,strDistrict=@strDistrict,ccodeid=@ccodeid where lngopUseraddressId=@id";
            SqlParameter[] paras = new SqlParameter[]{
            new SqlParameter("@id",ba.Id),
            new SqlParameter("@strConsigneeName",ba.StrConsigneeName),
            new SqlParameter("@strConsigneeTel",ba.StrConsigneeTel),
        ...
        public DataTable DL_SOAAutoSendBySel()
        {
            ...
            string cmdText = "select aa.strLoginName,bb.cCusCode,bb.cCusName,isnull(cc.ccdefine1,0) SOASendTime from Dl_opUser aa left join Customer bb on aa.cCusCode=left(bb.cCusCode,6) left join Customer_extradefine cc on bb.cCusCode=cc.cCusCode  where aa.strUserLevel=3 and strStatus=1  order by bb.cCusCode";
            dt = sqlhelper.ExecuteQuery(cmdText, CommandType.Text);
            return dt;
        }
        #endregion
