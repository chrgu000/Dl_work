...
namespace BLL
{
    public class OrderManager
    {
        ...
        {
            return odao.DLproc_NewOrderByIns(oi, areaid, iaddresstype, chdefine21, cWhCode);
        }
        #endregion
        ...
        {
            return odao.DLproc_NewYYOrderByIns(oi, areaid, iaddresstype, chdefine21);
        }
        #endregion
        ...
        {
            return odao.DLproc_NewOrderDetailByIns(oi, cbdefine16);
        }
        #endregion
        ...
        {
            return odao.DLproc_NewYYOrderDetailByIns(oi, cbdefine16, cDefine24);
        }
        #endregion
        ...
        /// <returns></returns>
        public DataTable DLproc_QuasiOrderDetailModifyBySel(string cinvcode, string cCusCode, string strBillNo, string cbdefine16)
        {
            return odao.DLproc_QuasiOrderDetailModifyBySel(cinvcode, cCusCode, strBillNo,cbdefine16);
        }
        #endregion
        ...
        {
            return odao.DL_RejectOrderBillForExpTimeByUpd(strBillNo, strManagers);
        }
        #endregion
        ...
        {
            return odao.DLproc_NewOrderByUpd(oi, areaid, iaddresstype, chdefine21, cdefine8,cWhCode);
        }
        #endregion
        ...
        {
            return odao.DLproc_NewYOrderByUpd(oi, areaid, iaddresstype, chdefine21, cdefine8);
        }
        #endregion
        ...
        {
            return odao.DLproc_NewYOrderByIns(ddate, lngopUserId, bytStatus, ccuscode, ccusname, lngBillType, cdiscountname, cMemo, lngopUserExId, strAllAcount, datDeliveryDate);
        }
        #endregion
        ...
        ///// <param name="strBillNo">网单号</param>
        ///// <returns></returns>
        //public DataTable DLproc_BackOrderandPrvOrdercInvCodeIsBeLimitedBySel(int lngopOrderBackId, int iShowType, int iBillType)
        //{
        //    return odao.DLproc_BackOrderandPrvOrdercInvCodeIsBeLimitedBySel(  lngopOrderBackId,   iShowType,   iBillType);
        //}
        //#endregion
        ...
        {
            return odao.DLproc_AddOrderBackByIns(lngopUserId, strBillName, bytStatus, strRemarks, ccuscode, cdefine1, cdefine2, cdefine3, cdefine9, cdefine10, cdefine11, cdefine12, cdefine13, ccusname, cpersoncode, cSCCode, strLoadingWays, cSTCode, lngopUseraddressId, RelateU8NO, lngBillType, cWhCode);
        }
        #endregion
        ...
        /// <summary>
        /// 查询当月前未确认的订单（如不确认则不能下单）[DL_NotConfirmedSOABySel]
        /// </summary>
