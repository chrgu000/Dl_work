...
namespace BLL
{
    public class BasicInfoManager
    {
        ...
        {
            return bdao.Insert_UserAddressPS(lngopUserId, strDistributionType, strConsigneeName, strConsigneeTel, strReceivingAddress, strDistrict,ccodeid);
        }
        #endregion

        #region 新增加(配送)[Insert_UserAddressZTPS]
        /// <summary>
        /// 新增加(配送)
        /// </summary>
        /// <param name="lngopUserId">用户id</param>
        ...
        {
            return bdao.Insert_UserAddressZTPS(lngopUserId, strDistributionType, strConsigneeName, strConsigneeTel, strReceivingAddress, strDistrict,ccodeid);
        }
        #endregion
        ...
        #endregion
        #region  修改(自提需配送)[Update_UserAddressZTPS]
        /// <summary>
        /// 修改(配送)
        /// </summary>
        /// <param name="ba"></param>
        ...
        {
            return bdao.Update_UserAddressZTPS(ba,ccodeid);
        }
        #endregion
        #endregion
