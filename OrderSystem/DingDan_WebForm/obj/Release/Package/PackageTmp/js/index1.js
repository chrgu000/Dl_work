...
//layui.extend({//设定组件别名
//    common: 'common',
//    navbar: '/js/plugins/layui-1.0.9/lay/modules/extendplus/navbar/navbar',
//    tab: 'navbar/tab',
...
layui.use(['layer', 'navbar'], function () {
    var layer = layui.layer, navbar = layui.navbar();
    ...
    navbar.render();
    // var h = $("#admin-navbar-side").html();
    //h = '<div id="sidebar" class="sidebar-fold"><i class="fa fa-hand-o-left"></i></div>' + h;
    // $("#admin-navbar-side").html(h);
    // navbar.render();


    //添加tips		                  
    // var li = $("#admin-side").find("li");
    var dd = $(".layui-nav-tree").find("dd");


    //li.hover(function () {

    //    var minitips = $("#admin-side").hasClass("sidebar-mini");
    //    if (minitips) {
    //        console.log(li)
