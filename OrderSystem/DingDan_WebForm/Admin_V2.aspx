<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Admin_V2.aspx.cs" Inherits="DingDan_WebForm.Admin_V2" %>
    ...
    <div class="layui-layout layui-layout-admin">
            ...
            <div class="layui-main">
                ...
                <ul class="layui-nav admin-header-item">
                    ...
                    <li class="layui-nav-item">
                        <a href="javascript:;" class="admin-header-user">
                            ...
                            <asp:Label   runat="server" ID="Login_Name" />
                            <%--<span>beginner</span>--%>
                        </a>
                ...
                <ul class="layui-nav admin-header-item-mobile">
                    <li class="layui-nav-item">
                        <a href="javascript:;" class="admin-header-user">
                            <img src="/images/0.jpg" />
                            <asp:Label  runat="server" ID="Login_Name_Mobile" />
                            <%--<span>beginner</span>--%>
                        </a>
                        <dl class="layui-nav-child">
                            <dd>
        ...
        <div class="layui-side layui-bg-black" id="admin-side">
            ...
            <div class="layui-side-scroll" id="admin-navbar-side" lay-filter="side">
                <%--      <div id="sidebar" class="sidebar-fold"><i class="fa fa-bars"></i></div>--%>
            </div>
        </div>
        ...
        <script type="text/javascript" src="/js/datas/admin_nav.js"></script>
        ...
        <script>
            layui.use('layer', function () {
                ...
                $.ajax({
                    ...
                    dataType: "Json",
                    data: { "Action": "Check_Level" },
                    success: function (data) {
                        if (data.flag != '1') {
                             window.location.href = "Login_V2.html"
                        }
                        else {
                            $("#Login_Name").text(data.message)
                            $("#Login_Name_Mobile").text(data.message)
                        }
                    }
                });
