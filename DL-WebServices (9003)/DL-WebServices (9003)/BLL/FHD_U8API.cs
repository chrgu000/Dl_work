...
namespace BLL
{
    ...
    {
        /// <summary>
        /// U8API调用-非金花、大井仓库，金花仓库-1，大井仓库-2
        /// </summary>
        /// <param name="strBillNo">网上订单参照订单的编号</param>
        /// <param name="s">拆单标识</param>
        /// <returns></returns>
        public String AddFHDAPI(string strBillNo, int s)
        {
        ...
        public String AddFHD(string strBillNo)
        {
            string aa = "";
            for (int i = 1; i < 4; i++)
            {
                aa = AddFHDAPI(strBillNo, i);
