...
namespace BLL
{
    public class SearchManager
    {
        ...
        {
            return sdao.DL_PreOrderTreeBySel(cCusCode, lngBillType);
        }
        #endregion
        ...
        {
            return sdao.DLproc_OrderExecuteBySel(strBillNo, ccuscode, begindate, enddate, showtype, FHStatus);
        }
        #endregion
        ...
        {
            return sdao.DLproc_OrderExecuteFordatAuditordTimeBySel(strBillNo, ccuscode, begindate, enddate, showtype, FHStatus);
        }
        #endregion
        ...
        {
            return sdao.DL_WXaccesstokenByUpd(accesstoken);
        }
        #endregion
        ...
        {
            return sdao.DL_GetWXAppIdBySel();
        }
        #endregion
        ...
        {
            return sdao.DL_WXFWHaccesstokenByUpd(FWH_access_token);
        }
        #endregion
        ...
        {
            return sdao.SMSRecord(phone, content, result, msgGroup);
        }
        #endregion

        #region 短信发送记录
        public bool SMSRecord(string phone, string content, string resultStr, string msgGroup, string rspcod, string success,int res)
        {
            return sdao.SMSRecord(phone, content, resultStr, msgGroup, rspcod, success,res);
        }
        #endregion
        ...
        {
            return sdao.SMSReport(phone, submitDate, receiveDate, errorCode, msgGroup, reportStatus);
        }
        #endregion
        ...
        {
            return sdao.WXMsgRecord(toUser, sendMsg, resultMsg, agentid, msgType);
        }
        #endregion
