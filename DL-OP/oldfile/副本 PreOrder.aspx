<%@ Page Language="C#" AutoEventWireup="true" CodeFile="副本 PreOrder.aspx.cs" Inherits="PreOrder" %>
    ...
    <form id="form1" runat="server">
        ...
        <div>
            <dx:ASPxGridView ID="OrderGrid" ClientInstanceName="OrderGrid" runat="server" AutoGenerateColumns="False" EnableTheming="True" KeyFieldName="cInvCode"
                ...
                <SettingsText Title="订单明细表" ConfirmOnLosingBatchChanges="未保存的数据将被丢失,是否离开?" EmptyDataRow="请选择商品" />
...
Inventory.Hide();
                    ...
                    <div style="float: left">
                        <dx:ASPxTreeList ID="treeList" runat="server" AutoGenerateColumns="False" Caption="选择物料大类 ↓"
                            ...
                            <SettingsBehavior AllowFocusedNode="True" AllowSort="False"  ProcessFocusedNodeChangedOnServer="True" 
                                ProcessSelectionChangedOnServer="True" AllowDragDrop="False" ExpandCollapseAction="NodeDblClick" FocusNodeOnExpandButtonClick="False" FocusNodeOnLoad="False" />
                            <SettingsCookies CookiesID="PreOrder" Enabled="True" />
                            <SettingsDataSecurity AllowDelete="False" AllowEdit="False" AllowInsert="False" />
                            <Images>
            ...
            treeList.PerformCustomDataCallback(key);
                    ...
                    <div style="float: left;">
                                ...
                                <dx:ASPxGridView ID="TreeDetail" ClientInstanceName="TreeDetail" runat="server" AutoGenerateColumns="False" Theme="Office2010Blue" 
                                    ...
                                    <SettingsPager Visible="False" Mode="EndlessPaging" NumericButtonCount="99">
                                    </SettingsPager>
                                    ...
                                    <SettingsText CommandApplySearchPanelFilter="查找" CommandClearSearchPanelFilter="清除" EmptyDataRow="没有数据" SearchPanelEditorNullText="请输入查询关键字" />
