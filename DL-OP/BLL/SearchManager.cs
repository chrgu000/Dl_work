...
namespace BLL
{
    public class SearchManager
    {
        ...
        {
            return sdao.DL_CustomerCodeBySel(phone,pwd);
        }
        #endregion
        ...
        {
            return sdao.DLproc_TreeListDetailsAllBySel(cInvCCode, cCusCode, iShowType);
        }
        #endregion

        #region 获取物料树明细_特殊订单(全部,包含大类)[DLproc_TreeListDetailsAll_TSBySel]
        /// <summary>
        /// 获取物料树明细_特殊订单(全部,包含大类)[DLproc_TreeListDetailsAll_TSBySel]
        /// </summary>
        /// <param name="cInvCCode">物料大类代码</param>
        /// <param name="cCusCode">顾客代码</param>
        /// <returns></returns>
        ...
        {
            return sdao.DLproc_TreeListDetailsAll_TSBySel(cInvCCode, cCusCode);
        }
        #endregion
        ...
        {
            return sdao.DLproc_TreeListPreDetails_TSBySel(strBillNo, lngBillType);
        }
        #endregion
        ...
        {
            return sdao.DL_U8SOASearchOfOperBySel(ComboPeriodYear_exp, ComboPeriodMon_exp);
        }
        #endregion
        ...
        {
            return sdao.DLproc_OrderExecuteBySel(strBillNo, ccuscode, begindate, enddate, showtype, FHStatus, user);
        }
        #endregion
        ...
        {
            return sdao.DLproc_OrderExecuteFordatAuditordTimeBySel(strBillNo, ccuscode, begindate, enddate, showtype, FHStatus,user);
        }
        #endregion
        ...
        {
            return sdao.DL_AllCountBySel(strUser);
        }
        #endregion
        ...
        {
            return sdao.DLproc_NewOrderToDispU8ByIns(BillNo);
        }
        #endregion
        ...
        {
            return sdao.DL_CZTSCheckBySel(BillNo);
        }
        #endregion
