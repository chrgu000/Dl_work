<%@ page language="C#" autoeventwireup="true" inherits="OrderModify, dlopwebdll" enableviewstate="false" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div>
            <table align="left" style="width: 100%; float: none;">
                <tr>
                    <td class="auto-style15" style="font-size: 12pt">网单号</td>
                    <td class="auto-style2" style="font-size: 12pt">
                    ...
                    <td class="auto-style3" style="font-size: 12pt">制单人</td>
                    <td class="auto-style2" style="font-size: 12pt">
                    ...
                    <td class="auto-style15" style="font-size: 12pt">订单日期</td>
                    <td class="auto-style21" style="font-size: 12pt">
                    ...
                    <td class="auto-style4" style="font-size: 12pt">
                ...
                <tr>
                    <td class="auto-style19" style="font-size: 12pt">开票单位</td>
                    <td class="auto-style13" style="font-size: 12pt">
                    ...
                    <td class="auto-style19" style="font-size: 12pt">到期时间</td>
                    <td class="auto-style13" style="font-size: 12pt">
                        <dx:ASPxTextBox ID="TxtdatExpTime" ClientInstanceName="TxtdatExpTime" runat="server" Width="160px" Height="18px" EnableTheming="True" Theme="Office2010Blue" Text="" CssClass="auto-style16">
                            <ReadOnlyStyle BackColor="White" />
                        </dx:ASPxTextBox>


                    </td>
                    <td class="auto-style19" style="font-size: 12pt">信用额</td>
                    <td class="auto-style22" style="font-size: 12pt">
                    ...
                    <td class="auto-style13" style="font-size: 12pt"><a style="float:left;display:none;">酬宾类型</a><dx:ASPxTextBox ID="TxtCBLX" ClientInstanceName="TxtCBLX" runat="server" Width="135px" Height="18px" EnableTheming="True" ReadOnly="True" style="margin-bottom: 0px;display:none">
                            </dx:ASPxTextBox></td>
                </tr>
                <tr>
                    <td class="auto-style18" style="font-size: 12pt">送货方式</td>
                    <td class="auto-style5" colspan="3" style="font-size: 12pt">
                    ...
                    <td class="auto-style18" style="font-size: 12pt">发运方式</td>
                    <td class="auto-style23" style="font-size: 12pt">
                    ...
                    <td class="auto-style5" style="font-size: 12pt"></td>
                </tr>
                <tr>
                    <td class="auto-style6" style="font-size: 12pt">备注</td>
                    <td class="auto-style6" style="font-size: 12pt">
	...
	SetCookieText(s.GetText());
                    ...
                    <td class="auto-style6" style="font-size: 12pt">车型</td>
                    <td class="auto-style6" style="font-size: 12pt">
                        <div style="float: left;">
                    ...
                    <td class="auto-style6" style="font-size: 12pt">装车方式</td>
                    <td class="auto-style24" style="font-size: 12pt">
	...
	SetCookieTextTxtLoadingWays(s.GetText());
                    ...
                    <td class="auto-style6" style="font-size: 12pt"></td>
                </tr>
                <tr>
                    <td class="auto-style20" style="font-size: 12pt">下单时间</td>
                    <td class="auto-style20" style="font-size: 12pt">
                    ...
                    <td class="auto-style20" style="font-size: 12pt">提货时间</td>
                    <td class="auto-style20" style="font-size: 12pt">
	...
	SetCookieTextDeliveryDate(s.GetText());
                    ...
                    <td class="auto-style20" style="font-size: 12pt">销售类型</td>
                    ...
                    <td class="auto-style20" style="font-size: 12pt"></td>
                </tr>
            </table>
        </div>
        <div>
            ...
            <dx:ASPxGridView ID="OrderGrid" ClientInstanceName="OrderGrid" runat="server" AutoGenerateColumns="False" EnableTheming="True" KeyFieldName="cInvCode"
                ...
                OnHtmlDataCellPrepared="OrderGrid_HtmlDataCellPrepared" OnInit="OrderGrid_Init"
                OnRowUpdating="OrderGrid_RowUpdating" OnCustomUnboundColumnData="GridViewShippingMethod_CustomUnboundColumnData" Width="1230px" Font-Size="11pt">
                ...
                <TotalSummary>
                    ...
                    <dx:ASPxSummaryItem FieldName="cComUnitAmount" SummaryType="Sum" DisplayFormat="{0:F}" ShowInColumn="金额" />
                    <dx:ASPxSummaryItem DisplayFormat="合计:" FieldName="cInvName" ShowInColumn="单价" SummaryType="Count" />
                </TotalSummary>
                <Columns>
                    <dx:GridViewCommandColumn ShowDeleteButton="True" VisibleIndex="0" ButtonType="Button" Width="65px">
                        <HeaderTemplate>
...
Inventory.Show()	
                    ...
                    <dx:GridViewDataHyperLinkColumn Caption="删除" FieldName="cInvCode" VisibleIndex="1" ReadOnly="True" Width="38px" Visible="False">
                        <PropertiesHyperLinkEdit NavigateUrlFormatString="OrderModify.aspx?code={0}" Text="删除">
                ...
                <SettingsBehavior AllowSort="False" AllowFocusedRow="True" SortMode="Value" />
...
<%--                        <dx:ASPxHyperLink ID="HyBack" runat="server" Text="返回" ClientInstanceName="HyBack" EnableTheming="True" Font-Names="微软雅黑" 
                            Font-Size="13pt" ForeColor="White" Height="33px" Target="_self" Theme="Office2010Blue" Width="90px" 
                            BackColor="#F99F44" BorderLeft-BorderWidth="10" >
                            <ClientSideEvents Click="function(s, e) {
 if (confirm('确定要返回吗？')){
         window.parent.location ='PendingOrder.aspx';
         }	
}" />
                            <BorderLeft BorderColor="#F99F44" BorderStyle="Solid" BorderWidth="50px" />
                            <BorderTop BorderColor="#F99F44" BorderStyle="Solid" BorderWidth="10px" />
                        </dx:ASPxHyperLink>--%>
...
<dx:ASPxGridView ID="GridViewShippingMethod" runat="server" AutoGenerateColumns="False" EnableTheming="True"
                                                    ...
                                                    OnCustomUnboundColumnData="GridViewShippingMethod_CustomUnboundColumnData" Font-Size="9pt">
...
dbclick();	
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataTextColumn ShowInCustomizationForm="True" VisibleIndex="1" Caption="lngopUseraddressId" FieldName="lngopUseraddressId" ReadOnly="True" Visible="False">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="序号" FieldName="hh" UnboundType="Integer" ShowInCustomizationForm="True" VisibleIndex="2" Width="50px">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn ShowInCustomizationForm="True" VisibleIndex="3" Caption="联系信息" FieldName="ShippingInformation">
                                                            <Settings AutoFilterCondition="Contains" />
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="cDefine9" FieldName="strConsigneeName" ReadOnly="True" ShowInCustomizationForm="True" Visible="False" VisibleIndex="4">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="cDefine12" FieldName="strConsigneeTel" ReadOnly="True" ShowInCustomizationForm="True" Visible="False" VisibleIndex="5">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="cDefine11" FieldName="strReceivingAddress" ReadOnly="True" ShowInCustomizationForm="True" Visible="False" VisibleIndex="6">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="cDefine10" FieldName="strCarplateNumber" ReadOnly="True" ShowInCustomizationForm="True" Visible="False" VisibleIndex="7">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="cDefine1" FieldName="strDriverName" ReadOnly="True" ShowInCustomizationForm="True" Visible="False" VisibleIndex="8">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="cDefine13" FieldName="strDriverTel" ReadOnly="True" ShowInCustomizationForm="True" Visible="False" VisibleIndex="9">
                                                        </dx:GridViewDataTextColumn>
                                                        <dx:GridViewDataTextColumn Caption="cDefine2" FieldName="strIdCard" ReadOnly="True" ShowInCustomizationForm="True" Visible="False" VisibleIndex="10">
                                                        </dx:GridViewDataTextColumn>
                                                    </Columns>
...
Customer_dbclick();	
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <dx:GridViewDataTextColumn Caption="序号" FieldName="hh" UnboundType="Integer" ShowInCustomizationForm="True" VisibleIndex="1" ReadOnly="True" Width="50px">
                                                        </dx:GridViewDataTextColumn>
                                                    ...
                                                    <SettingsBehavior AllowFocusedRow="True" AllowSort="False" />
                                                    <SettingsPager AlwaysShowPager="True" NumericButtonCount="15" PageSize="15" Mode="ShowAllRecords">
                                                    </SettingsPager>
