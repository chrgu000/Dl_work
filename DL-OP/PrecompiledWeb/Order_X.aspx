<%@ page language="C#" autoeventwireup="true" inherits="Order_X, dlopwebdll" enableviewstate="false" %>
                    ...
                    <td class="auto-style6">
                        <div style="float: left;">
                            <dx:ASPxTextBox ID="Txtztadd" runat="server" ClientInstanceName="Txtztadd" EnableTheming="True" Height="18px" ReadOnly="True" Width="130px" NullText="自提必须选择行政区！">
                             ...
                             </div >   <div style="float: left;">                        <dx:ASPxButton ID="ASPxButton4" runat="server" Text="选择" Width="40px" Height="18px" AutoPostBack="false" Theme="Office2010Blue">
	...
	SetCookieTextDeliveryDate(s.GetText());
        ...
        <div>
            <dx:ASPxGridView ID="OrderGrid" ClientInstanceName="OrderGrid" runat="server" AutoGenerateColumns="False" EnableTheming="True" KeyFieldName="itemid"
                ...
                OnRowUpdating="OrderGrid_RowUpdating" OnCustomUnboundColumnData="GridViewShippingMethod_CustomUnboundColumnData" Width="1330px" Font-Size="10pt">
...
Inventory.Show()	
                    ...
                    <dx:GridViewDataTextColumn Caption="执行单价" FieldName="ExercisePrice" VisibleIndex="23" Width="0px" ReadOnly="true">
                    </dx:GridViewDataTextColumn>
                    <dx:GridViewDataTextColumn Caption="执行金额" FieldName="xx" UnboundType="Decimal" VisibleIndex="24" Width="0px" ReadOnly="true">
                    </dx:GridViewDataTextColumn>
                </Columns>
...
cdefine3.Hide();
        ...
        <dx:ASPxPopupControl ID="Inventory" runat="server" CloseAction="CloseButton" LoadContentViaCallback="OnFirstShow"
            PopupElementID="Inventory" PopupVerticalAlign="TopSides" PopupHorizontalAlign="OutsideLeft"
            ShowFooter="True" Width="900px" Height="350px" HeaderText="选择商品" ClientInstanceName="Inventory" CloseOnEscape="True" Modal="True" Theme="Office2010Blue">
            <ContentCollection>
...
Inventory.Hide();
                    ...
                    <div style="float: left;margin-top:5px">
                        <dx:ASPxTreeList ID="treeList" runat="server" AutoGenerateColumns="False" Caption="选择特殊订单 ↓"
                            ...
                            ParentFieldName="strBillNo" Theme="Office2010Blue" Width="300px" Font-Size="9pt">
                            <Columns>
                                <dx:TreeListTextColumn Caption="特殊订单" FieldName="strBillNo" ReadOnly="True" ShowInCustomizationForm="True" VisibleIndex="0">
                                </dx:TreeListTextColumn>
                            </Columns>
                            <Settings ScrollableHeight="288" VerticalScrollBarMode="Auto" />
                            ...
                            <ContentTemplate>
                             ...
                             <%--   <input id='ctl' type='button' onclick='cscode();' style="display: none;" />--%>
                                <dx:ASPxGridView ID="TreeDetail" ClientInstanceName="TreeDetail" runat="server" AutoGenerateColumns="False" Theme="Office2010Blue"
                                    ShowVerticalScrollBar="true" KeyFieldName="itemid" PreviewFieldName="itemid" Caption="选择物料明细 ↓" Width="515px" Font-Size="9pt">
                                    <Columns>
                                    ...
                                    <Settings VerticalScrollBarMode="Visible" ShowFooter="False" ShowTitlePanel="True" VerticalScrollableHeight="288" />
