<%@ page language="C#" autoeventwireup="true" inherits="XPreOrder, dlopwebdll" enableviewstate="false" %>
        ...
        <div>
            <table align="left" style="width: 100%; float: none;">
                <tr>
                    ...
                    <td class="auto-style4"><div style="display:none;">
                        ...
                        <dx:ASPxTextBox ID="TxtBillTime" runat="server" Width="185px" Height="18px" ReadOnly="True" Theme="Office2010Blue"   >
                        </dx:ASPxTextBox></div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td class="auto-style19">备注</td>
                    <td class="auto-style21">
                        <dx:ASPxTextBox ID="TxtOrderMark" runat="server" Width="500px">
                        </dx:ASPxTextBox>
                    </td>
        ...
        <div>
            ...
            <dx:ASPxGridView ID="OrderGrid" ClientInstanceName="OrderGrid" runat="server" AutoGenerateColumns="False" EnableTheming="True" KeyFieldName="cInvCode" 
                ...
                <TotalSummary>
                    ...
                    <dx:ASPxSummaryItem FieldName="cComUnitAmount" SummaryType="Sum" ShowInGroupFooterColumn="规格" DisplayFormat="合计:{0:F}" ShowInColumn="金额" />
                </TotalSummary>
                <Columns>
...
Inventory.Show()	
                    ...
                    <dx:GridViewDataTextColumn Caption="起订量" FieldName="MinOrderQTY" VisibleIndex="13" Width="60px" ReadOnly="True">
                    </dx:GridViewDataTextColumn>
                </Columns>
                    ...
                    <div style="float: left;">
                                ...
                                <dx:ASPxGridView ID="TreeDetail" ClientInstanceName="TreeDetail" runat="server" AutoGenerateColumns="False" Theme="Office2010Blue"
                                    ...
                                    <Columns>
                                        ...
                                        <dx:GridViewDataImageColumn Caption=" " FieldName="img" VisibleIndex="1" Width="26px">
