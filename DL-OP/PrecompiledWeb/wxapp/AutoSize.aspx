<%@ page language="C#" autoeventwireup="true" inherits="wxapp_AutoSize, dlopwebdll" enableviewstate="false" %>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <div id="searchcontBtn" runat="server">
                        <dx:ASPxButton ID="ASPxButton1" runat="server" Text="查询" Width="80px" OnClick="ASPxButton1_Click">
                            <ClientSideEvents Click="function(s, e) {
document.getElementById('searchcontBtn').style.display = 'none';document.getElementById('searchcont').style.display = 'none';
}" />
                        </dx:ASPxButton>
