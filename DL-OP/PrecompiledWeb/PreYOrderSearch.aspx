<%@ page language="C#" autoeventwireup="true" inherits="PreYOrderSearch, dlopwebdll" enableviewstate="false" %>
    ...
    <div style="float: left;margin-right:5px">
        ...
        <div>
                <dx:ASPxGridView ID="Grid" runat="server" AutoGenerateColumns="False" EnableTheming="True" KeyFieldName="strBillNo" Theme="Office2010Blue" Font-Size="10pt">
                    <Columns>
                        <dx:GridViewDataTextColumn Caption="正式订单号" FieldName="cSOCode" VisibleIndex="1" Width="140px">
                        </dx:GridViewDataTextColumn>
                        <dx:GridViewDataTextColumn Caption="状态" FieldName="bytStatus" VisibleIndex="2" Width="80px">
                        </dx:GridViewDataTextColumn>
                        ...
                        <dx:GridViewDataHyperLinkColumn Caption="网单号" FieldName="strBillNo" VisibleIndex="0" Width="140px">
                            <PropertiesHyperLinkEdit NavigateUrlFormatString="PreYOrderDetail.aspx?id={0}" Target="OrderCenter">
                ...
                <div style="width:100%;height:600px">
                        <iframe id="OrderCenter" height="100%" width="100%" frameborder="0" name="OrderCenter" src="PreYOrderDetail.aspx"></iframe>
        </div>
