<%@ page language="C#" autoeventwireup="true" inherits="_Default, dlopwebdll" enableviewstate="false" %>
...
setPWD.Hide();
            ...
            <div class="easyui-tabs" fit="true" border="false" id="tabs">
                <div title="首页" iconcls="icon-dl_zy">
                    <br />
                    <h3>2016-03-29更新</h3>
                    <a style="font-size: 10pt;">★添加用户取回功能(订单提交后在待审核订单中,如果该订单没有被接单员接收处理,则用户可以自行取回再进行编辑后提交,取回后可在被驳回订单中找到该订单,并进行编辑).</a>
                    <br />
                    <a style="font-size: 10pt;">★修复临时订单自动保存会被其他用户的临时订单自动保存的信息覆盖的问题.</a>
                    <br />
                    <a style="font-size: 10pt;">★订单执行情况表由下单日期查询变更为下单时间查询,增加审核时间查询.</a>
                    <br />
                    <a style="font-size: 10pt;">★增加特殊订单明细显示.</a>
                    <h3>2016-03-28更新</h3>
                    <a style="font-size: 10pt;">★普通订单增加保存临时订单功能,使用该功能,可以将在制的订单保存为临时订单,保存后可以在任意时候通过按钮"临时订单",在弹出界面中选择对应的订单,点击确定或者双击即可完成临时订单信息提取.<br />
                        &nbsp;&nbsp;&nbsp;&nbsp;保存的临时订单不会自动删除,请不需要使用该订单后手工删除,避免存储太多临时订单造成混乱.</a>
                    <br />
                    <a style="font-size: 10pt;">★普通订单增加自动保存临时订单功能,在添加完商品后会自动保存临时订单,名称为"系统自动保存".</a>
                    <br />
                    <a style="font-size: 10pt;">★样品资料订单可以关联任意订单(不再需要关联通过审核的订单),请各位关联准确的主订单号.</a><br />
                    <a style="font-size: 10pt;">★待审核订单中,合计金额显示为执行金额汇总.</a><br />
                    <br />
                    <a style="font-size: 10pt;">★2016-3-17日,更新:增加'参照历史订单'的重复购买功能</a><br />
                    <a style="font-size: 10pt;">★2016-3-16日,更新:更新选择商品搜索方式,增加常用商品,价格检测,库存颜色标识等</a><br />
                    <a style="font-size: 10pt;">★2016-3-10日,更新:优化订单执行情况表(添加总合计,单个订单的合计颜色,合计排序,添加开票单位筛选)</a><br />
                    <a style="font-size: 10pt;">★2016-3-9日,更新:添加检测功能(顾客提交订单时,检测开票单位名称与编码是否一致)</a><br />
                    <a style="font-size: 10pt;">★ 2016-3-8日,更新:优化历史订单的查询(修复点击订单号查看详细信息时会重置查询的条件和表单数据)</a><br />
                    <a style="font-size: 10pt;">★2016-3-6日,更新:添加报表功能,&quot;订单执行情况表</a><br />
                    <a style="font-size: 10pt;">★2016-3-5日,更新:历史订单明细中可查询合计金额</a><br />
...
<script type="text/javascript">
    $(function () {
        ...
        var treeData = [{
...

            {
                ...
                children: [
                    {
                        text: "预订单处理", iconCls: "icon-dl_redo",
                        state: "closed",
                        children: [
                            {
                                text: "待处理酬宾订单", iconCls: "icon-dl_redo",
                                attributes: { url: "../dluser/Atasks_Y.aspx" }
                            }, {
                                text: "待办酬宾订单", iconCls: "icon-dl_redo",
                                attributes: {
                                    url: "../dluser/Gtasks_Y.aspx"
                                }
                            }, {
                                text: "待处理特殊订单", iconCls: "icon-dl_redo",
                                attributes: {
                                    url: "../dluser/Atasks_X.aspx"
                                }
                            }, {
                                text: "待办特殊订单", iconCls: "icon-dl_redo",
                                attributes: {
                                    url: "../dluser/Gtasks_X.aspx"
                                }
                            }, {
                                text: "预订单已办工作", iconCls: "icon-dl_redo",
                                attributes: {
                                    url: "../dluser/Ptasks.aspx"
                                }
                            }
                        ]
                    },
 ...
 //                   },
            ...
            {
                text: "活动设置", iconCls: "icon-dl_pz",
                attributes: {
                    url: "../dluser/ActivityContent.aspx"
                }, url: "../dluser/ActivityContent.aspx"
            },
                        {
                            text: "所有操作", iconCls: "icon-dl_pz",
                            attributes: {
                                url: "../dluser/ALLOP.aspx"
                            }, url: "../dluser/ALLOP.aspx"
                        },
