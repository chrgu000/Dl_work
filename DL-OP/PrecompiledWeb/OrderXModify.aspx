<%@ page language="C#" autoeventwireup="true" inherits="OrderXModify, dlopwebdll" enableviewstate="false" %>
                ...
                <ContentTemplate>
                    <div>
                        ...
                        <div style="float: left; width: 1000px; margin-bottom: 5px">
                            ...
                            <a style="float: left; margin-left: 20px">到期时间:</a><dx:ASPxTextBox ID="TxtdatExpTime" ClientInstanceName="TxtdatExpTime" runat="server" Width="140px" Style="float: left; border-style: none;" ReadOnly="true"></dx:ASPxTextBox>
...
Inventory.Show()	
                                ...
                                <dx:GridViewDataTextColumn Caption="编码" FieldName="cInvCode" ReadOnly="True" Visible="False" VisibleIndex="1">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="名称" FieldName="cInvName" ReadOnly="True" VisibleIndex="3" Width="150px">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="规格" FieldName="cInvStd" ReadOnly="True" VisibleIndex="4" Width="100px">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="基本单位" FieldName="cComUnitName" ReadOnly="True" VisibleIndex="7" Width="50px">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="小包装单位" FieldName="cInvDefine2" ReadOnly="True" VisibleIndex="9" Width="55px">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="大包装单位" FieldName="cInvDefine1" ReadOnly="True" VisibleIndex="11" Width="55px">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="单位组" FieldName="UnitGroup" ReadOnly="True" VisibleIndex="5" Width="120px">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="单价" FieldName="cComUnitPrice" ReadOnly="True" VisibleIndex="16" Width="50px">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="金额" FieldName="cComUnitAmount" ReadOnly="True" VisibleIndex="17" Width="100px">
                                    <EditFormSettings Visible="False" />
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="基本单位汇总" FieldName="cInvDefineQTY" ReadOnly="True" VisibleIndex="12" Width="80px">
                                </dx:GridViewDataTextColumn>
                                ...
                                <dx:GridViewDataSpinEditColumn Caption="基本单位数量" EditFormSettings-VisibleIndex="0" FieldName="cComUnitQTY" VisibleIndex="6" Width="70px">
                                ...
                                <dx:GridViewDataTextColumn Caption="预订单号" FieldName="ccode" ReadOnly="True" VisibleIndex="20" Width="0px">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="物料编码+预订单号" FieldName="itemid" ReadOnly="True" VisibleIndex="21" Width="0px">
                                </dx:GridViewDataTextColumn>
                                <dx:GridViewDataTextColumn Caption="库存量" FieldName="Stock" ReadOnly="True" VisibleIndex="14" Width="60px">
                                </dx:GridViewDataTextColumn>
                            ...
                            <Settings HorizontalScrollBarMode="Auto" ShowFooter="True" ShowTitlePanel="true" VerticalScrollableHeight="200" VerticalScrollBarMode="Auto" />
                            <SettingsText CommandCancel="取消" CommandDelete="删除" CommandUpdate="确定" />
...
Inventory.Hide();
                                    ...
                                    <div style="float: left">
                                        <dx:ASPxTreeList ID="treeList" runat="server" AutoGenerateColumns="False" Caption="选择特殊订单 ↓"
                                            ...
                                            ParentFieldName="strBillNo" Theme="Office2010Blue" Width="335px" Font-Size="9pt">
                                            <Columns>
