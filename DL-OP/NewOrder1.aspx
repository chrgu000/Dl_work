<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewOrder1.aspx.cs" Inherits="NewOrder1" %>
...
<body>
                ...
                <tr>
                    ...
                    <td class="auto-style13">
                        <div style="float: left">
                            <dx:ASPxTextBox ID="TxtCustomer" ClientInstanceName="TxtCustomer" runat="server" Width="125px" ReadOnly="True" Theme="Office2010Blue" Text="" Height="18px" EnableViewState="true" CssClass="auto-style16" BackColor="#3366FF">
                                <ReadOnlyStyle BackColor="White">
                                </ReadOnlyStyle>
                            </dx:ASPxTextBox>
                        </div>
	...
	SetCookieTextDeliveryDate(s.GetText());
                    ...
                    <td class="auto-style7">
                        <div style="float: left; margin-left: 5px">
                            <dx:ASPxTextBox ID="TxtcSTCode" runat="server" Width="108px" Height="18px" EnableTheming="True" ReadOnly="True" Theme="Office2010Blue" CssClass="auto-style16" BackColor="#3366FF" Text="普通订单">
                                <ReadOnlyStyle BackColor="White">
                                </ReadOnlyStyle>
                            </dx:ASPxTextBox>
   ...
   <%--                         <dx:ASPxButton ID="ASPxButton4" runat="server" Text="选择" Width="40px" AutoPostBack="false" Theme="Office2010Blue" Height="16px">
        ...
        <div>
            ...
            <dx:ASPxGridView ID="OrderGrid" ClientInstanceName="OrderGrid" runat="server" AutoGenerateColumns="False" EnableTheming="True" KeyFieldName="cInvCode" OnRowDeleting="OrderGrid_RowDeleting"
                ...
                OnRowUpdating="OrderGrid_RowUpdating" OnCustomUnboundColumnData="GridViewShippingMethod_CustomUnboundColumnData" Width="1260px" KeyboardSupport="True">
 ...
 Inventory.Show()	
                    ...
                    <dx:GridViewDataTextColumn Caption="执行金额" FieldName="xx" ReadOnly="True" UnboundType="Decimal" VisibleIndex="20" Width="0px">
                    </dx:GridViewDataTextColumn>
                </Columns>
