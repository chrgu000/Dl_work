...
public partial class test_process : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        #endregion
        //绑定treelist数据源
        DataTable dttree = new SearchManager().DLproc_InventoryBySel(Session["cSTCode"].ToString(),"abc");
        ...
        {
            dt1 = new SearchManager().DLproc_TreeListDetailsBySel(Session["ordertreelistgrid"].ToString(), Session["KPDWcCusCode"].ToString());
    ...
    protected void btn_Click(object sender, EventArgs e)
    {
        ...
        //Session["gridselect"] = dtst;
        //绑定gridview数据源
        DataTable dt1 = new SearchManager().DLproc_TreeListDetailsBySel(Session["ordertreelistgrid"].ToString(), Session["KPDWcCusCode"].ToString());
        TreeDetail.DataSource = dt1;
        TreeDetail.DataBind();
        //删除当前绑定的数据,因为切换分类,所以需要删除
        DataTable dtst = (DataTable)Session["gridselect"];
