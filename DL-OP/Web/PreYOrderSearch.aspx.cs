...
public partial class PreYOrderSearch : System.Web.UI.Page
{
    ...
    protected void BtnOk_Click(object sender, EventArgs e)
    {
        ...
        dt = new OrderManager().DLproc_MyWorkPreYOrderForCustomerBySel(BillNo, BeginDate, EndDate, OrderStatus, lngopUserId, "1");
        Grid.DataSource = dt;
        Grid.DataBind();
    }
}