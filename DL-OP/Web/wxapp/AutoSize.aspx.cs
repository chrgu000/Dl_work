...
public partial class wxapp_AutoSize : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string combobox = GetJsonString();
      
        //Response.Write(combobox.ToString());
        //Response.End();
    ...
    new combobox(){id="strBillNo",text="5.5"},  
    new combobox(){id="datBillTime",text="2.5"},  
        new combobox(){id="cdefine11",text="5.5"},  
    new combobox(){id="isum",text="2.5"},  
        new combobox(){id="U8iFHMoney",text="5.5"},  
    new combobox(){id="U8iTHMoney",text="2.5"}
    };
        comboboxList comboboxLists = new comboboxList();
        comboboxLists.Getcombobox = comboboxs;
        return new JavaScriptSerializer().Serialize(comboboxLists);
    }
