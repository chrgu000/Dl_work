<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrderFrameDlUser.aspx.cs" Inherits="dluser_OrderFrameDlUser" %>
...
<%--                <tr>
                    <td colspan="3" style="height: 30px;">
                        <dx:ASPxMenu ID="ASPxMenu1" runat="server" EnableTheming="True" OnItemClick="ASPxMenu1_ItemClick" Theme="Office2010Blue">
                            <Items>
                                <dx:MenuItem NavigateUrl="~/OrderMaterialDlUser.aspx" Target="OrderLeft" Text="刷新档案">
                                </dx:MenuItem>
                            </Items>
                        </dx:ASPxMenu>
                    </td>
                ...
                <tr>
                   <%-- <td width="350" id="frmTitle" nowrap="noWrap" name="fmTitle" valign="top" height="600">
                        <iframe id="OrderLeft" height="100%" width="100%" frameborder="0" src="OrderMaterialDlUser.aspx"
                    ...
                    <td valign="top" width="*%" height="600">
                        <iframe id="OrderCenter" height="100%" width="100%" frameborder="0" name="OrderCenter" src="OrderDlUser.aspx"></iframe>
                    </td>
                </tr>
            </table>
        </div>
