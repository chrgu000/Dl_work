...
public partial class dluser_Stasks : System.Web.UI.Page
{
    ...
    protected void BtnOk_Click(object sender, EventArgs e)
    {
        ...
        dt = new OrderManager().DLproc_MyWorkBySel(BillNo, BeginDate, EndDate, cSTCode, OrderStatus, strManagers);
        Grid.DataSource = dt;
        Grid.DataBind();
    ...
    {
        //获取关闭行的订单号
        string strBillNo = Grid.GetRowValues(e.VisibleIndex, "strBillNo").ToString();
        //关闭订单
        ...
        Grid.DataSource = dt;
        Grid.DataBind();
        //Page.ClientScript.RegisterStartupScript(Page.GetType(), "message", "<script language='javascript' defer>alert('订单关闭成功！');</script>");
    }
}