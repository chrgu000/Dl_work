<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrderMaterialDlUser.aspx.cs" Inherits="dluser_OrderMaterialDlUser" %>
                    ...
                    <dx:ASPxGridView ID="TreeDetail" ClientInstanceName="TreeDetail" runat="server" AutoGenerateColumns="False" Theme="Office2010Blue"
                        ...
                        <Columns>
                            ...
                            <dx:GridViewDataHyperLinkColumn Caption="选择" FieldName="cInvCode" VisibleIndex="3" Width="35px">
                                <PropertiesHyperLinkEdit NavigateUrlFormatString="OrderDlUser.aspx?id={0}" Target="OrderCenter" Text="添加">
                        ...
                        <Settings ShowFilterRow="True" VerticalScrollBarMode="Visible" ShowFooter="False" ShowTitlePanel="True" />
